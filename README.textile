...
"oui_player_video":https://github.com/NicolasGraph/oui_player_video is a "oui_player":https://github.com/NicolasGraph/oui_player v2+ extension to easily embed "HTML video":https://video.com/ provided videos in "Textpattern":https://textpattern.com/ powered websites.
...
oui_player_html's minimum requirements:
...
# "Download":https://github.com/NicolasGraph/oui_player_html/releases the compiled plugin file or the source to compile a customized file.
...
# Install oui_player_html:
@$ composer require oui/oui_player_html@
...
bc. $ composer update oui/oui_player_html
...
bc. $ composer remove oui/oui_player_html

h2. Video tags and parameters
...
* comma separated list of *File ID's*;
* comma separated list of *filenames* using one of the following extension: @.mp3@, @.ogg@, @.oga@ or @.wav@;
* comma separated list of *URL's* using one of the following extensions: @.mp3@, @.ogg@, @.oga@ or @.wav@;
* *Name of a field* containing any of the above value.
...
oui_player_html version 1.0.0, Copyright (C) 2018 Nicolas Morand
...
* *oui_player_html v1.0.0-beta* (2018-06-24)
